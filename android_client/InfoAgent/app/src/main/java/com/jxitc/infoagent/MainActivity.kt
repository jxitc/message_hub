...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            InfoAgentTheme {
                InfoAgentApp(appContainer, ::requestDataCollectionPermissions)
            }
        }
    }
    ...
    private fun requestDataCollectionPermissions() {
        val allPermissions = PermissionHelper.SMS_PERMISSIONS + PermissionHelper.CONTACTS_PERMISSIONS
...
@Composable
fun InfoAgentApp(
    appContainer: com.jxitc.infoagent.di.AppContainer,
